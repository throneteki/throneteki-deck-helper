...
function getAgenda(deck) {
    var agenda = deck.cards.find(function (c) {
        return c.card.type === 'agenda';
    });
    ...
    return {
        ...
        rules: [{
            ...
            condition: function condition(deck) {
                return getDeckCount(deck.cards.filter(function (cardQuantity) {
                    return isDrawCard(cardQuantity.card) && cardQuantity.card.faction === faction;
                })) >= 12;
            }
        }]
    };
...
var agendaRules = {
    ...
    '01027': {
        rules: [{
            ...
            condition: function condition(deck) {
                return getDeckCount(deck.cards.filter(function (cardEntry) {
                    return isDrawCard(cardEntry.card) && cardEntry.card.faction === 'neutral';
                })) <= 15;
            }
        }]
    },
    ...
    '04037': {
        ...
        rules: [{
            ...
            condition: function condition(deck) {
                return !deck.cards.some(function (cardQuantity) {
                    return cardQuantity.card.type === 'plot' && hasTrait(cardQuantity.card, 'Winter');
                });
            }
        }]
    },
    ...
    '04038': {
        ...
        rules: [{
            ...
            condition: function condition(deck) {
                return !deck.cards.some(function (cardQuantity) {
                    return cardQuantity.card.type === 'plot' && hasTrait(cardQuantity.card, 'Summer');
                });
            }
        }]
    },
    ...
    '05045': {
        ...
        rules: [{
            ...
            condition: function condition(deck) {
                var schemePlots = deck.cards.filter(function (cardQuantity) {
                    return cardQuantity.card.type === 'plot' && hasTrait(cardQuantity.card, 'Scheme');
                });
        ...
        rules: [{
            ...
            condition: function condition(deck) {
                return deck.cards.filter(function (c) {
                    return c.card.traits.includes('Banner').length <= 2;
                });
            }
        }]
    },
    ...
    '00001': rulesForDraft({
        ...
        rules: [{
            ...
            condition: function condition(deck) {
                var outOfFactionCards = deck.cards.filter(function (cardQuantity) {
...
var DeckValidator = function () {
    ...
    _createClass(DeckValidator, [{
        ...
        value: function validateDeck(deck) {
            ...
            var plotCount = getDeckCount(deck.cards.filter(function (c) {
                return c.card.type === 'plot';
            }));
            var drawCount = getDeckCount(deck.cards.filter(function (c) {
                return isDrawCard(c.card);
            }));
            ...
            try {
                for (var _iterator4 = allCards[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                    var _cardQuantity = _step4.value;
            ...
            try {
                for (var _iterator5 = Object.values(cardCountByName)[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
            ...
            var includesDraftCards = this.isDraftCard(agenda) || allCards.some(function (cardQuantity) {
        ...
        value: function getAgendaRules(deck) {
            ...
            var allAgendas = [agenda].concat(deck.cards.filter(function (c) {
                return c.card.traits.includes('Banner') && c.card !== agenda;
            }).map(function (c) {
                return c.card;
            }));
